...
//            List<Grupo> usrPost = mapper.readValues(new URL("localhost:9092/get_grupos_usuario?id_usuario="+usuario.getId()), new TypeReference(){});
		...
		//Redirige a la creación de grupos necesaria la Ip de Creación de grupos
		modelAndView.addObject("crearGrupo","<a href=http://172.16.147.151:9092?id_usuario="+usuario.getId()+"><button>Crear Grupo</button></a> ");
